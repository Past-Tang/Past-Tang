...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:161b22,100:1a1b27&height=200&section=header&text=Tang&fontSize=70&fontColor=58a6ff&animation=fadeIn&fontAlignY=32&desc=Full-Stack%20%7C%20Blockchain%20%7C%20AI&descSize=16&descColor=8b949e&descAlignY=62" width="100%"/>
...
- **AI** -- YOLO 目标检测、LLM 大模型、OCR 文字识别
- **逆向工程** -- 浏览器自动化、Frida Hook、验证码识别
...
<a href="https://skillicons.dev">
  <img src="https://skillicons.dev/icons?i=python,javascript,typescript,vue,nodejs,flask,html,css&theme=dark" alt="Languages"/>
</a>
<br/>
<a href="https://skillicons.dev">
  <img src="https://skillicons.dev/icons?i=docker,linux,git,github,vscode,mysql,mongodb,redis&theme=dark" alt="Tools"/>
</a>
<br/><br/>
...
![Frida](https://img.shields.io/badge/Frida-EF6C00?style=for-the-badge)
...
|:---|:---|:---|
| [chaoxing-sign](https://github.com/Past-Tang/chaoxing-sign) | 学习通自动签到 + 微信推送 | Python |
| [jd-invoice-merge](https://github.com/Past-Tang/jd-invoice-merge) | 京东发票自动合并开具 (Frida + CDP) | Python, Frida |
| [solana-token-analyzer](https://github.com/Past-Tang/solana-token-analyzer) | Solana 代币链上分析工具包 | Python, Helius API |
| [okx-volume-monitor](https://github.com/Past-Tang/okx-volume-monitor) | OKX 合约大单监控 + 自动交易 | Python, WebSocket |
| [telegram-signal-analyzer](https://github.com/Past-Tang/telegram-signal-analyzer) | Telegram 交易信号监控 + Gate.io | Python, Telethon |
